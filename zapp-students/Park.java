...
public class Park implements ZAPP {
    ...
    /**
     * Returns a String representation of all the cards in all areas including the
     * name of each area
     * 
     * @return a String representation of all cards on specified area
     **/
     ...
     * the source area, added to the destination area, card details updated and a
     ...
     **/
    public String move(int pCardId, String brCode) { // other checks optional
